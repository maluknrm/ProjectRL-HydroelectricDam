...
def run():
    ...
    for _ in range(num_runs):
        ...
        #plt.show()
        print("Results:")
        print(f"The return of test set after applying the Tabular Q-Learning after {num_episodes} episodes was: {val_episode_returns[-1]} (Vincents Env)")

        val_episode_lengths, val_episode_returns, val_viz_data = agent.evaluate_policy(env_val, Q_policy)

        print("Results:")
        print(f"The return of the test set after applying the Tabular Q-Learning after {num_episodes} episodes was: {val_episode_returns[-1]} (Our Env)")
